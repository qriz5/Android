...
@Composable
fun SearchIdScreen(navController : NavController, viewModel : LoginViewModel){
    ...
    Surface {
        Column(modifier = Modifier
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                Text(text = "아이디를 잊으셨나요?", fontWeight = FontWeight.Bold, fontSize = 24.sp)
                Spacer(modifier = Modifier.height(8.dp))
                Text(text = "Qriz에 가입했던 이메일을 입력하시면 " + "\n"+
                        "아이디를 메일로 보내드립니다.", fontWeight = FontWeight.Medium, fontSize = 16.sp)
